...
class NetworkHandler :  NSObject {
    ...
    func fetchEmployees(completion: @escaping (Result<Employees, Error>) -> Void) {
        let urlString = "https://mocki.io/v1/91301250-3f98-40f7-8405-edb9070ce46d"
...
/*
 API RESPONSE: (create a dummy api for this response....)
